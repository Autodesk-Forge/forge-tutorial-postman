...
In order to extract geometry, you must identify the Viewable the geometry resides on.  A Viewable is a 3D or 2D view that can be displayed in the Forge Viewer.  
