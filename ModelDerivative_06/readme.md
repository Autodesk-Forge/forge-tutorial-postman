...
This folder contains a Postman Collection that contains the requests used in the Model Derivative Step-by-Step Tutorial [Extract Geometry from a Source File](https://dev.forge.autodesk.com/en/docs/model-derivative/v2/tutorials/xtract-geometry-from-source-file/?sha=8948_24), which is published on the Forge portal. 
