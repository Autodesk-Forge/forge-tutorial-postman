...
This folder contains a Postman Collection that contains the requests used in the Model Derivative Step-by-Step Tutorial [Extract Metadata from a Source File](https://forge.autodesk.com/en/docs/model-derivative/v2/tutorials/xtract-metadata/), which is published on the Forge portal. 
...
![Forge portal menu to Postman](images/tutorial_05_forge_postman_menu_01.png "Forge portal task to Postman mapping")
...
![Forge portal steps to Postman](images/tutorial_05_forge_postman_menu_02.png "Forge portal task to Postman mapping")
