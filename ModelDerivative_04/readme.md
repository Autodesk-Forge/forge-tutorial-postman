...
This folder contains a Postman Collection that contains the requests used in the Model Derivative Step-by-Step Tutorial [Extract Metadata from a Source File](://dev.forge.autodesk.com/en/docs/model-derivative/v2/tutorials/xtract-metadata/about-this-tutorial/?sha=8948_24), which is published on the Forge portal. 
